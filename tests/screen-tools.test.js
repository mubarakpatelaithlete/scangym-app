...
test('chat-agent.js performs only the listed screen actions, via the functions the buttons use', () => {
  ...
  assert.match(src, /var ACTIONS = \{ go_to_tab: goToTab, share: share, open_gym: openGym, open_write_review: openWriteReview, music: music, open_create: openCreate, open_url: openUrl \};/, 'closed vocabulary');
