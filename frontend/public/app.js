...
function CreatorsPage(){
  ...
  const assets = [
    ...
    // — AI Cinematic —
    {name:'Affiliateearnings V1',file:'AffiliateEarnings_v1.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Ba Ninetydays',file:'BA-NinetyDays.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Ba Theconfidence',file:'BA-TheConfidence.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Ba Thehoodie',file:'BA-TheHoodie.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Ba Thephoto',file:'BA-ThePhoto.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Ba Twoversions',file:'BA-TwoVersions.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bk Membershiptrap',file:'BK-MembershipTrap.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bk Sixtygyms',file:'BK-SixtyGyms.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bk Theflex',file:'BK-TheFlex.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bk Thesecret',file:'BK-TheSecret.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bk Thevisitors',file:'BK-TheVisitors.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bs Summercoming',file:'BS-SummerComing.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Bs Thestandard',file:'BS-TheStandard.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Beforeafter Freedom V1',file:'BeforeAfter_Freedom_v1.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Beforeafter Wallet V2',file:'BeforeAfter_Wallet_v2.mp4',type:'video',cat:'AI Cinematic'},
    {name:'C01 Huberman Clip',file:'C01_Huberman_Clip.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cq Thefeeling',file:'CQ-TheFeeling.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cq Themirror',file:'CQ-TheMirror.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cq Therestart',file:'CQ-TheRestart.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cq Theversion',file:'CQ-TheVersion.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cq Twoweeks',file:'CQ-TwoWeeks.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cw Hemsworth',file:'CW-Hemsworth.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cw Ronaldo',file:'CW-Ronaldo.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cw Therock',file:'CW-TheRock.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cw Tyson',file:'CW-Tyson.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Cw Zyzz',file:'CW-Zyzz.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fc Thebet',file:'FC-TheBet.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fc Thedare',file:'FC-TheDare.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fc Theexcuses',file:'FC-TheExcuses.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fc Theexperiment',file:'FC-TheExperiment.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fc Thetag',file:'FC-TheTag.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fs Sixmonths',file:'FS-SixMonths.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fs Thedecision',file:'FS-TheDecision.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fs Theletter',file:'FS-TheLetter.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fs Thepromise',file:'FS-ThePromise.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Fs Thethankyou',file:'FS-TheThankYou.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gh Atmosphere',file:'GH-Atmosphere.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gh Discipline',file:'GH-Discipline.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gh Equipment',file:'GH-Equipment.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gh Results',file:'GH-Results.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gh Thetruth',file:'GH-TheTruth.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gs Theanxiety',file:'GS-TheAnxiety.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gs Thebreakup',file:'GS-TheBreakup.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gs Theconfidence',file:'GS-TheConfidence.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gs Thedarkplace',file:'GS-TheDarkPlace.mp4',type:'video',cat:'AI Cinematic'},
    {name:'Gs Thediscipline',file:'GS-TheDiscipline.mp4',type:'video',cat:'AI Cinematic'},
    // — Audience Posts —
    {name:'Beginners',file:'beginners.png',type:'image',cat:'Audience Posts'},
    {name:'Busy Professionals',file:'busy_professionals.png',type:'image',cat:'Audience Posts'},
    {name:'Couples',file:'couples.png',type:'image',cat:'Audience Posts'},
    {name:'Gym Hoppers',file:'gym_hoppers.png',type:'image',cat:'Audience Posts'},
    {name:'Parents',file:'parents.png',type:'image',cat:'Audience Posts'},
    {name:'Runners',file:'runners.png',type:'image',cat:'Audience Posts'},
    {name:'Seniors',file:'seniors.png',type:'image',cat:'Audience Posts'},
    {name:'Shift Workers',file:'shift_workers.png',type:'image',cat:'Audience Posts'},
    {name:'Students',file:'students.png',type:'image',cat:'Audience Posts'},
    {name:'Travellers',file:'travellers.png',type:'image',cat:'Audience Posts'},
    // — Banners —
    {name:'How It Works 01',file:'how_it_works_01.png',type:'image',cat:'Banners'},
    {name:'How It Works 02',file:'how_it_works_02.png',type:'image',cat:'Banners'},
    // — CTA Templates —
    {name:'Dm Us Gym',file:'dm_us_gym.png',type:'image',cat:'CTA Templates'},
    {name:'Drop A 💪',file:'drop_a_💪.png',type:'image',cat:'CTA Templates'},
    {name:'Link In Bio',file:'link_in_bio.png',type:'image',cat:'CTA Templates'},
    {name:'Share Your Code',file:'share_your_code.png',type:'image',cat:'CTA Templates'},
    {name:'Swipe Left',file:'swipe_left.png',type:'image',cat:'CTA Templates'},
    {name:'Tag A Friend',file:'tag_a_friend.png',type:'image',cat:'CTA Templates'},
    // — City Promo Reels —
    {name:'Aberdeen',file:'aberdeen.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Bath',file:'bath.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Brighton',file:'brighton.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Cambridge',file:'cambridge.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Cardiff',file:'cardiff.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Coventry',file:'coventry.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Derby',file:'derby.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Edinburgh',file:'edinburgh.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Leicester',file:'leicester.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Nottingham',file:'nottingham.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Oxford',file:'oxford.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Plymouth',file:'plymouth.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Reading',file:'reading.mp4',type:'video',cat:'City Promo Reels'},
    {name:'Southampton',file:'southampton.mp4',type:'video',cat:'City Promo Reels'},
    {name:'York',file:'york.mp4',type:'video',cat:'City Promo Reels'},
    // — City Promo Square —
    {name:'Birmingham',file:'birmingham.mp4',type:'video',cat:'City Promo Square'},
    {name:'Bolton',file:'bolton.mp4',type:'video',cat:'City Promo Square'},
    {name:'Bristol',file:'bristol.mp4',type:'video',cat:'City Promo Square'},
    {name:'Glasgow',file:'glasgow.mp4',type:'video',cat:'City Promo Square'},
    {name:'Leeds',file:'leeds.mp4',type:'video',cat:'City Promo Square'},
    {name:'Liverpool',file:'liverpool.mp4',type:'video',cat:'City Promo Square'},
    {name:'London',file:'london.mp4',type:'video',cat:'City Promo Square'},
    {name:'Manchester',file:'manchester.mp4',type:'video',cat:'City Promo Square'},
    {name:'Newcastle',file:'newcastle.mp4',type:'video',cat:'City Promo Square'},
    {name:'Sheffield',file:'sheffield.mp4',type:'video',cat:'City Promo Square'},
    // — Daily Motivation —
    {name:'Friday',file:'friday.png',type:'image',cat:'Daily Motivation'},
    {name:'Monday',file:'monday.png',type:'image',cat:'Daily Motivation'},
    {name:'Saturday',file:'saturday.png',type:'image',cat:'Daily Motivation'},
    {name:'Sunday',file:'sunday.png',type:'image',cat:'Daily Motivation'},
    {name:'Thursday',file:'thursday.png',type:'image',cat:'Daily Motivation'},
    {name:'Tuesday',file:'tuesday.png',type:'image',cat:'Daily Motivation'},
    {name:'Wednesday',file:'wednesday.png',type:'image',cat:'Daily Motivation'},
    // — Did You Know —
    {name:'Fact 01',file:'fact_01.png',type:'image',cat:'Did You Know'},
    {name:'Fact 02',file:'fact_02.png',type:'image',cat:'Did You Know'},
    {name:'Fact 03',file:'fact_03.png',type:'image',cat:'Did You Know'},
    {name:'Fact 04',file:'fact_04.png',type:'image',cat:'Did You Know'},
    {name:'Fact 05',file:'fact_05.png',type:'image',cat:'Did You Know'},
    {name:'Fact 06',file:'fact_06.png',type:'image',cat:'Did You Know'},
    {name:'Fact 07',file:'fact_07.png',type:'image',cat:'Did You Know'},
    {name:'Fact 08',file:'fact_08.png',type:'image',cat:'Did You Know'},
    // — Did You Know Videos —
    {name:'Fact 01',file:'fact_01.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 02',file:'fact_02.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 03',file:'fact_03.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 04',file:'fact_04.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 05',file:'fact_05.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 06',file:'fact_06.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 07',file:'fact_07.mp4',type:'video',cat:'Did You Know Videos'},
    {name:'Fact 08',file:'fact_08.mp4',type:'video',cat:'Did You Know Videos'},
    // — Engagement Posts —
    {name:'This Or That 01',file:'this_or_that_01.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 02',file:'this_or_that_02.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 03',file:'this_or_that_03.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 04',file:'this_or_that_04.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 05',file:'this_or_that_05.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 06',file:'this_or_that_06.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 07',file:'this_or_that_07.png',type:'image',cat:'Engagement Posts'},
    {name:'This Or That 08',file:'this_or_that_08.png',type:'image',cat:'Engagement Posts'},
    // — General Videos —
    {name:'01 Tiktok Hook Vertical',file:'01_tiktok_hook_vertical.mp4',type:'video',cat:'General Videos'},
    {name:'02 Gym Lifestyle Vertical',file:'02_gym_lifestyle_vertical.mp4',type:'video',cat:'General Videos'},
    {name:'03 Youtube Ad Horizontal',file:'03_youtube_ad_horizontal.mp4',type:'video',cat:'General Videos'},
    // — Gym Spotlights —
    {name:'24 7 Gym Card',file:'24_7_gym_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Boxing Card',file:'boxing_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Calisthenics Card',file:'calisthenics_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Crossfit Card',file:'crossfit_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Cycling Card',file:'cycling_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Hiit Card',file:'hiit_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Luxury Card',file:'luxury_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Mma Card',file:'mma_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Pilates Card',file:'pilates_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Swimming Card',file:'swimming_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Weights Card',file:'weights_card.png',type:'image',cat:'Gym Spotlights'},
    {name:'Yoga Card',file:'yoga_card.png',type:'image',cat:'Gym Spotlights'},
    // — Hero Videos —
    {name:'01 Gym Entry Vertical',file:'01_gym_entry_vertical.mp4',type:'video',cat:'Hero Videos'},
    {name:'02 Phone Tap Vertical',file:'02_phone_tap_vertical.mp4',type:'video',cat:'Hero Videos'},
    {name:'03 Workout Montage Horizontal',file:'03_workout_montage_horizontal.mp4',type:'video',cat:'Hero Videos'},
    // — Influencer Clips —
    {name:'S01 Huberman',file:'S01_Huberman.mp4',type:'video',cat:'Influencer Clips'},
    {name:'S06 Goggins',file:'S06_Goggins.mp4',type:'video',cat:'Influencer Clips'},
    {name:'S11 Hormozi',file:'S11_Hormozi.mp4',type:'video',cat:'Influencer Clips'},
    {name:'S17 Ksi',file:'S17_KSI.mp4',type:'video',cat:'Influencer Clips'},
    {name:'S25 Genz',file:'S25_GenZ.mp4',type:'video',cat:'Influencer Clips'},
    // — Instagram Posts —
    {name:'01 No Membership Hero',file:'01_no_membership_hero.png',type:'image',cat:'Instagram Posts'},
    {name:'02 How It Works',file:'02_how_it_works.png',type:'image',cat:'Instagram Posts'},
    {name:'03 Any Gym Any Time',file:'03_any_gym_any_time.png',type:'image',cat:'Instagram Posts'},
    {name:'04 Earn With Scangym',file:'04_earn_with_scangym.png',type:'image',cat:'Instagram Posts'},
    {name:'05 Founder Quote',file:'05_founder_quote.png',type:'image',cat:'Instagram Posts'},
    {name:'06 Vs Membership',file:'06_vs_membership.png',type:'image',cat:'Instagram Posts'},
    {name:'07 Testimonial Template',file:'07_testimonial_template.png',type:'image',cat:'Instagram Posts'},
    {name:'08 Gym Types Carousel',file:'08_gym_types_carousel.png',type:'image',cat:'Instagram Posts'},
    // — Instagram Stories —
    {name:'02 Download App',file:'02_download_app.png',type:'image',cat:'Instagram Stories'},
    {name:'04 Before After',file:'04_before_after.png',type:'image',cat:'Instagram Stories'},
    // — Lifestyle AI —
    {name:'Busy Professional',file:'busy_professional.png',type:'image',cat:'Lifestyle AI'},
    {name:'Early Bird',file:'early_bird.png',type:'image',cat:'Lifestyle AI'},
    {name:'Gym Hopper',file:'gym_hopper.png',type:'image',cat:'Lifestyle AI'},
    {name:'Night Owl',file:'night_owl.png',type:'image',cat:'Lifestyle AI'},
    {name:'Student Budget',file:'student_budget.png',type:'image',cat:'Lifestyle AI'},
    {name:'Traveller',file:'traveller.png',type:'image',cat:'Lifestyle AI'},
    // — Memes —
    {name:'Meme 01',file:'meme_01.png',type:'image',cat:'Memes'},
    {name:'Meme 02',file:'meme_02.png',type:'image',cat:'Memes'},
    {name:'Meme 03',file:'meme_03.png',type:'image',cat:'Memes'},
    {name:'Meme 04',file:'meme_04.png',type:'image',cat:'Memes'},
    {name:'Meme 05',file:'meme_05.png',type:'image',cat:'Memes'},
    {name:'Meme 06',file:'meme_06.png',type:'image',cat:'Memes'},
    {name:'Meme 07',file:'meme_07.png',type:'image',cat:'Memes'},
    {name:'Meme 08',file:'meme_08.png',type:'image',cat:'Memes'},
    {name:'Meme 09',file:'meme_09.png',type:'image',cat:'Memes'},
    {name:'Meme 10',file:'meme_10.png',type:'image',cat:'Memes'},
    // — Price Comparison Vids —
    {name:'Vs Anytime Fitness',file:'vs_anytime_fitness.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs David Lloyd',file:'vs_david_lloyd.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs Fitness First',file:'vs_fitness_first.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs Jd Gyms',file:'vs_jd_gyms.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs Nuffield Health',file:'vs_nuffield_health.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs Puregym',file:'vs_puregym.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs The Gym Group',file:'vs_the_gym_group.mp4',type:'video',cat:'Price Comparison Vids'},
    {name:'Vs Virgin Active',file:'vs_virgin_active.mp4',type:'video',cat:'Price Comparison Vids'},
    // — Price Comparisons —
    {name:'Anytime Fitness Vs',file:'anytime_fitness_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'David Lloyd Vs',file:'david_lloyd_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'Fitness First Vs',file:'fitness_first_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'Jd Gyms Vs',file:'jd_gyms_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'Nuffield Health Vs',file:'nuffield_health_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'Puregym Vs',file:'puregym_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'The Gym Group Vs',file:'the_gym_group_vs.png',type:'image',cat:'Price Comparisons'},
    {name:'Virgin Active Vs',file:'virgin_active_vs.png',type:'image',cat:'Price Comparisons'},
    // — Product Features —
    {name:'Scangym Cmo Howitworks 3Step',file:'ScanGym-CMO-HowItWorks-3Step.webp',type:'image',cat:'Product Features'},
    {name:'App Mockup',file:'app_mockup.png',type:'image',cat:'Product Features'},
    {name:'Map Pins',file:'map_pins.png',type:'image',cat:'Product Features'},
    {name:'Price Comparison',file:'price_comparison.png',type:'image',cat:'Product Features'},
    {name:'Qr Scan',file:'qr_scan.png',type:'image',cat:'Product Features'},
    // — Quotes & Stats —
    {name:'Quote 01',file:'quote_01.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 02',file:'quote_02.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 03',file:'quote_03.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 04',file:'quote_04.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 05',file:'quote_05.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 06',file:'quote_06.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 07',file:'quote_07.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 08',file:'quote_08.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 09',file:'quote_09.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 10',file:'quote_10.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 11',file:'quote_11.png',type:'image',cat:'Quotes & Stats'},
    {name:'Quote 12',file:'quote_12.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 01',file:'stat_01.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 02',file:'stat_02.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 03',file:'stat_03.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 04',file:'stat_04.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 05',file:'stat_05.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 06',file:'stat_06.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 07',file:'stat_07.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 08',file:'stat_08.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 09',file:'stat_09.png',type:'image',cat:'Quotes & Stats'},
    {name:'Stat 10',file:'stat_10.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 01',file:'testimonial_01.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 02',file:'testimonial_02.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 03',file:'testimonial_03.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 04',file:'testimonial_04.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 05',file:'testimonial_05.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 06',file:'testimonial_06.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 07',file:'testimonial_07.png',type:'image',cat:'Quotes & Stats'},
    {name:'Testimonial 08',file:'testimonial_08.png',type:'image',cat:'Quotes & Stats'},
    {name:'Vs 01',file:'vs_01.png',type:'image',cat:'Quotes & Stats'},
    {name:'Vs 02',file:'vs_02.png',type:'image',cat:'Quotes & Stats'},
    {name:'Vs 03',file:'vs_03.png',type:'image',cat:'Quotes & Stats'},
    // — Ready-to-Post —
    {name:'Citydiscovery Birmingham H0',file:'CityDiscovery_Birmingham_h0.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Citydiscovery Birmingham H1',file:'CityDiscovery_Birmingham_h1.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Citydiscovery Birmingham H2',file:'CityDiscovery_Birmingham_h2.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Citydiscovery Bolton H0',file:'CityDiscovery_Bolton_h0.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Citydiscovery Bolton H1',file:'CityDiscovery_Bolton_h1.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Citydiscovery Bolton H2',file:'CityDiscovery_Bolton_h2.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Creatorearnings Birmingham H0',file:'CreatorEarnings_Birmingham_h0.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Creatorearnings Birmingham H1',file:'CreatorEarnings_Birmingham_h1.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Creatorearnings Birmingham H2',file:'CreatorEarnings_Birmingham_h2.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Creatorearnings Bolton H0',file:'CreatorEarnings_Bolton_h0.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Creatorearnings Bolton H1',file:'CreatorEarnings_Bolton_h1.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Creatorearnings Bolton H2',file:'CreatorEarnings_Bolton_h2.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Dontjoinagym Birmingham Gbp10',file:'DontJoinAGym_Birmingham_GBP10.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Dontjoinagym Birmingham Gbp5',file:'DontJoinAGym_Birmingham_GBP5.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Dontjoinagym Birmingham Gbp7',file:'DontJoinAGym_Birmingham_GBP7.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Dontjoinagym Bolton Gbp10',file:'DontJoinAGym_Bolton_GBP10.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Dontjoinagym Bolton Gbp5',file:'DontJoinAGym_Bolton_GBP5.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Dontjoinagym Bolton Gbp7',file:'DontJoinAGym_Bolton_GBP7.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Howitworks Birmingham H0',file:'HowItWorks_Birmingham_h0.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Howitworks Birmingham H1',file:'HowItWorks_Birmingham_h1.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Howitworks Birmingham H2',file:'HowItWorks_Birmingham_h2.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Pricecompare Birmingham H0',file:'PriceCompare_Birmingham_h0.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Pricecompare Birmingham H1',file:'PriceCompare_Birmingham_h1.mp4',type:'video',cat:'Ready-to-Post'},
    {name:'Pricecompare Birmingham H2',file:'PriceCompare_Birmingham_h2.mp4',type:'video',cat:'Ready-to-Post'},
    // — Seasonal Themes —
    {name:'Back To Uni',file:'back_to_uni.png',type:'image',cat:'Seasonal Themes'},
    {name:'Black Friday',file:'black_friday.png',type:'image',cat:'Seasonal Themes'},
    {name:'Monday Motivation',file:'monday_motivation.png',type:'image',cat:'Seasonal Themes'},
    {name:'New Year Resolution',file:'new_year_resolution.png',type:'image',cat:'Seasonal Themes'},
    {name:'Summer Body',file:'summer_body.png',type:'image',cat:'Seasonal Themes'},
    {name:'Valentines',file:'valentines.png',type:'image',cat:'Seasonal Themes'},
    // — TikTok-Reels AI —
    {name:'Reel Morning Routine',file:'reel_morning_routine.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok 5 Pound',file:'tiktok_5_pound.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok Affiliate Earn',file:'tiktok_affiliate_earn.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok Any Gym',file:'tiktok_any_gym.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok Gym Hopping',file:'tiktok_gym_hopping.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok Membership Rip',file:'tiktok_membership_rip.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok Student Hack',file:'tiktok_student_hack.mp4',type:'video',cat:'TikTok-Reels AI'},
    {name:'Tiktok Walk In',file:'tiktok_walk_in.mp4',type:'video',cat:'TikTok-Reels AI'},
    // — UGC Videos —
    {name:'02152304Fbea45A4A5396C23Ba827Be9 B860C0646994925E9',file:'02152304fbea45a4a5396c23ba827be9-b860c0646994925e9c89b98a150c16b2-ld.mp4',type:'video',cat:'UGC Videos'},
    {name:'1',file:'1.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 30B9911B2A2B71Efbfc94531859C0102',file:'1.mp4_30b9911b2a2b71efbfc94531859c0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 40636Cc8D47671Eeba924531958D0102',file:'1.mp4_40636cc8d47671eeba924531958d0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 60A4A203Cb8A71Eeb5824531959C0102',file:'1.mp4_60a4a203cb8a71eeb5824531959c0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 709D7460Cae971Eeae8E4531958C0102',file:'1.mp4_709d7460cae971eeae8e4531958c0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 80B164782A2B71Efbfc94531859C0102',file:'1.mp4_80b164782a2b71efbfc94531859c0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 901Fcb4Ee45271Eebfc34531959D0102',file:'1.mp4_901fcb4ee45271eebfc34531959d0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 A00Cec70Caea71Eebfc45017F1F80102',file:'1.mp4_a00cec70caea71eebfc45017f1f80102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 A06Ec86Fd47671Eea8645017F0E80102',file:'1.mp4_a06ec86fd47671eea8645017f0e80102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 B05D6Aabe45271Eebc5C5420848D0102',file:'1.mp4_b05d6aabe45271eebc5c5420848d0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1.Mp4 C0B80D70Cb2571Eebfc35017F0E80102',file:'1.mp4_c0b80d70cb2571eebfc35017f0e80102.mp4',type:'video',cat:'UGC Videos'},
    {name:'10 Mubarak Pvc Sp100 S50 Sb75 V3 Processed',file:'10_Mubarak_pvc_sp100_s50_sb75_v3_PROCESSED.mp4',type:'video',cat:'UGC Videos'},
    {name:'12',file:'12.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 0Ab3D480673171Ee80116732B68E0102',file:'1_0ab3d480673171ee80116732b68e0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 122B9Ca068C871Ee80170764A3Fd0102',file:'1_122b9ca068c871ee80170764a3fd0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 1Edd9Fa0Ee1871Edbffe0764A0Ec0102',file:'1_1edd9fa0ee1871edbffe0764a0ec0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 22E2Dec0Ee1971Ed80540764A0Fd0102',file:'1_22e2dec0ee1971ed80540764a0fd0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 2Cb095E0673271Ee80116732B68E0102',file:'1_2cb095e0673271ee80116732b68e0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 3Cd66C50Ee1671Ed80546633B79F0102',file:'1_3cd66c50ee1671ed80546633b79f0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 3Dcff1D068C871Ee80406723B78E0102',file:'1_3dcff1d068c871ee80406723b78e0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 43392Bb0673271Ee988F5017F0E80102',file:'1_43392bb0673271ee988f5017f0e80102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 47Fefe80B72571Edbfd10764B3Ec0102',file:'1_47fefe80b72571edbfd10764b3ec0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 570B24C0Ee1771Edbffa6732B68E0102',file:'1_570b24c0ee1771edbffa6732b68e0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 57Df3310Ee1671Edbfec0764A3Fd0102',file:'1_57df3310ee1671edbfec0764a3fd0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 60Be1850Ee1871Ed80540764A0Fd0102',file:'1_60be1850ee1871ed80540764a0fd0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 6972B220932971Ed805D6633B79F0102',file:'1_6972b220932971ed805d6633b79f0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 6C8Ac4A0B72571Edbffe0764A3Fc0102',file:'1_6c8ac4a0b72571edbffe0764a3fc0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 80F9Fcc8Abb071Eea4386723A78F0102',file:'1_80f9fcc8abb071eea4386723a78f0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 85F19020Ee1871Edbfed0764A3Fd0102',file:'1_85f19020ee1871edbfed0764a3fd0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 86A94Ec0Ee1571Edbffe0764A0Ec0102',file:'1_86a94ec0ee1571edbffe0764a0ec0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 9D386Ce0Ee1871Ed80546633B79F0102',file:'1_9d386ce0ee1871ed80546633b79f0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 9Ea06B30Bbed71Ed80580674A2Ce0102',file:'1_9ea06b30bbed71ed80580674a2ce0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 A001E1E0C40F71Eebfdb5017F1E80102',file:'1_a001e1e0c40f71eebfdb5017f1e80102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 A840Dda0Bbed71Edbfee6732B68F0102',file:'1_a840dda0bbed71edbfee6732b68f0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 B08F5220Ee1571Edb0910674A2Ce0102',file:'1_b08f5220ee1571edb0910674a2ce0102.mp4',type:'video',cat:'UGC Videos'},
    {name:'1 B0E7Bfe8D12571Ee9Feb6732B68F0102',file:'1_b0e7bfe8d12571ee9feb6732b68f0102.mp4',type:'video',cat:'UGC Videos'},
    // — Viral Videos —
    {name:'Faketweet V01',file:'FakeTweet_v01.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V02',file:'FakeTweet_v02.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V03',file:'FakeTweet_v03.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V04',file:'FakeTweet_v04.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V05',file:'FakeTweet_v05.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V06',file:'FakeTweet_v06.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V07',file:'FakeTweet_v07.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V08',file:'FakeTweet_v08.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V09',file:'FakeTweet_v09.mp4',type:'video',cat:'Viral Videos'},
    {name:'Faketweet V10',file:'FakeTweet_v10.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V01',file:'HotTake_v01.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V02',file:'HotTake_v02.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V03',file:'HotTake_v03.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V04',file:'HotTake_v04.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V05',file:'HotTake_v05.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V06',file:'HotTake_v06.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V07',file:'HotTake_v07.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V08',file:'HotTake_v08.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V09',file:'HotTake_v09.mp4',type:'video',cat:'Viral Videos'},
    {name:'Hottake V10',file:'HotTake_v10.mp4',type:'video',cat:'Viral Videos'},
    {name:'Identityhook V01',file:'IdentityHook_v01.mp4',type:'video',cat:'Viral Videos'},
    {name:'Identityhook V02',file:'IdentityHook_v02.mp4',type:'video',cat:'Viral Videos'},
    {name:'Identityhook V03',file:'IdentityHook_v03.mp4',type:'video',cat:'Viral Videos'},
    {name:'Identityhook V04',file:'IdentityHook_v04.mp4',type:'video',cat:'Viral Videos'},
    {name:'Identityhook V05',file:'IdentityHook_v05.mp4',type:'video',cat:'Viral Videos'},
    {name:'Identityhook V06',file:'IdentityHook_v06.mp4',type:'video',cat:'Viral Videos'},
    // — YouTube AI —
    {name:'Yt Affiliate Explained',file:'yt_affiliate_explained.mp4',type:'video',cat:'YouTube AI'},
    {name:'Yt Every Gym Tested',file:'yt_every_gym_tested.mp4',type:'video',cat:'YouTube AI'},
    {name:'Yt No Membership',file:'yt_no_membership.mp4',type:'video',cat:'YouTube AI'},
    {name:'Yt Price Reveal',file:'yt_price_reveal.mp4',type:'video',cat:'YouTube AI'},
    // — YouTube Thumbs —
    {name:'01 Tried Every Gym',file:'01_tried_every_gym.png',type:'image',cat:'YouTube Thumbs'},
    {name:'02 No Membership Hack',file:'02_no_membership_hack.png',type:'image',cat:'YouTube Thumbs'},
    // — YouTube Thumbs AI —
    {name:'Yt 5 Pound Challenge',file:'yt_5_pound_challenge.png',type:'image',cat:'YouTube Thumbs AI'},
    {name:'Yt Gym Hack',file:'yt_gym_hack.png',type:'image',cat:'YouTube Thumbs AI'},
    {name:'Yt Membership Scam',file:'yt_membership_scam.png',type:'image',cat:'YouTube Thumbs AI'},
    ];
