      ...
      ov.innerHTML = [
        ...
        '<div class="sg-rbo-content">',
          ...
          '<div class="sg-rbo-pass-grid">',
            ...
            '<div class="sg-rbo-pass" data-pass="3day" onclick="sgSelectReelPass(this,\'3day\')"><div class="sg-rbo-pass-name">3-Day Pass</div><div class="sg-rbo-pass-price">' + sgGymPass(price,'3day',sym).display + '</div><div class="sg-rbo-pass-sub">Save ' + sgPassSave('3day') + '%</div></div>',
            '<div class="sg-rbo-pass" data-pass="weekly" onclick="sgSelectReelPass(this,\'weekly\')"><div class="sg-rbo-pass-name">Weekly</div><div class="sg-rbo-pass-price">' + sgGymPass(price,'weekly',sym).display + '</div><div class="sg-rbo-pass-sub">Save ' + sgPassSave('weekly') + '%</div></div>',
            '<div class="sg-rbo-pass" data-pass="monthly" onclick="sgSelectReelPass(this,\'monthly\')"><div class="sg-rbo-pass-name">Monthly</div><div class="sg-rbo-pass-price">' + sgGymPass(price,'monthly',sym).display + '</div><div class="sg-rbo-pass-sub">Best value</div></div>',
          '</div>',
