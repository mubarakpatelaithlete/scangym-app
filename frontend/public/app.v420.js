    ...
    <section id="fs-assets" class="px-4 py-16 bg-slate-900">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4" id="fs-grid">
          ${assets.map(a=>{
            const folder = a.type==='video' ? (a.cat==='CMO Content'?'videos/content':'videos/promo') : (a.cat==='Creator Assets'?'images/creator_assets':a.cat==='Branded'?'images/branded':a.cat==='Mascot'?'images/mascot':a.cat==='City Promos'?'images/city_promos':a.cat==='Story Templates'?'images/story_templates':a.cat==='Social Covers'?'images/social_covers':'images/marketing');
            return`
