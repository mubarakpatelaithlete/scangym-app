...
function ProfilePage(){
  ...
  return`<div style="padding:16px;max-width:480px;margin:0 auto">
    ...
    <div style="margin-top:24px;text-align:center">
      <p style="color:rgba(255,255,255,.3);font-size:12px;line-height:1.6">🌍 Your ScanGym profile is your universal gym pass.<br>Book any gym near you — no membership needed.</p>
    </div>
  </div>`;
}
